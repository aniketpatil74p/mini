...
#     if form.is_valid():
#             print("VALIDATION SUCCESS!")
#             # print("number: "+str(form.cleaned_data['number']))
#             # print(type(form.cleaned_data['number']))
#             # print(type(namenum))
#             # print(namenum)
#             return nextsteppe(request,form.cleaned_data['number'])

#     return render(request,'firstapp/form_page3.html',{'form':form})


# def form_name_viewer(request):
...
#             return nextstepper(request,form.cleaned_data['name'])

#     return render(request,'firstapp/form_page2.html',{'form':form})
...
#                 'list'     : li,
#     }
#     template = loader.get_template("firstapp/prefinal.html")
#     res = template.render(Context,request)
#     return HttpResponse(res)
...
# def nextstepper(request,nameprev):
#     import csv
#     filename =  "firstapp/download/downloaded1.csv"
#     data = open(filename, encoding = "utf8")
#     csv_data = csv.reader(data)
...
#         if(row[17] == nameprev):
#             print(nameprev)
#             prod_name = { "name" : row[5] }
#             prod_quantity = { "qunatity" : row[6] }
#             prod_price = { "price" : row[8]}
